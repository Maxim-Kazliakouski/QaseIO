...
public class TestListener implements ITestListener {
    ...
    public void onTestStart(ITestResult iTestResult) {
        System.out.printf("======================================== STARTING SCENARIO --> '%s' ========================================%n", scenarioName);
    }

    @Override
    public void onTestSuccess(ITestResult iTestResult) {
        System.out.printf("======================================== FINISHED SCENARIO --> '%s'; Duration: %ss ========================================%n", scenarioName, getExecutionTime(iTestResult));
    ...
    public void onTestFailure(ITestResult iTestResult) {
        System.out.printf("======================================== FAILED SCENARIO --> '%s'; Duration: %ss ========================================%n", scenarioName, getExecutionTime(iTestResult));
        log.info(format("========================= FAILED SCENARIO --> '%s'; Duration: %ss =========================", scenarioName, getExecutionTime(iTestResult)));
    ...
    public void onTestSkipped(ITestResult iTestResult) {
        System.out.printf("======================================== SKIPPING SCENARIO --> '%s' ========================================%n", scenarioName);
        log.info(format("========================= SKIPPING SCENARIO --> '%s' =========================", scenarioName));
        log.error(iTestResult.getThrowable().getMessage());
